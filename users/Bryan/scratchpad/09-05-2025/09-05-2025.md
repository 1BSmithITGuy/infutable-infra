...
- Boot → Talos installs to disk → reboots.
...
after booting from iso, check disk and NIC names:
```bash
talosctl -n 10.0.0.40 read /proc/partitions
talosctl -n 10.0.0.40 get links
```
